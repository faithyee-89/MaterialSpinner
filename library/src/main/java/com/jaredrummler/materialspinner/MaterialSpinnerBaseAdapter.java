...
//      }
    ...
    public MaterialSpinnerBaseAdapter<T> setItemBackgroundColor(@ColorInt int itemBackgroundColor) {
        this.itemBackgroundColor = itemBackgroundColor;
        return this;
    }

    public MaterialSpinnerBaseAdapter<T> setItemTextSize(float itemTextSize) {
