...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textColor = ta.getColor(R.styleable.MaterialSpinner_ms_text_color, textColor);
            ...
            itemBackgroundColor = ta.getColor(R.styleable.MaterialSpinner_ms_item_background_color, textColor);
            itemTextSize = ta.getFloat(R.styleable.MaterialSpinner_ms_item_text_size, 14f);
...
//        .setBackgroundSelector(backgroundSelector)    //下拉框的item不需要设置backgroundSelector
